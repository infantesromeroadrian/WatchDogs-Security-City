...
# =============================================================================
# PROMPT PARA COMPARACIÓN DE PERSONAS ENTRE FRAMES
# =============================================================================
FACE_COMPARISON_PROMPT = """Compara las descripciones de personas entre frames.

DESCRIPCIÓN DEL FRAME ANTERIOR:
{previous_description}

Analiza el nuevo frame y determina:
1. ¿Aparecen las MISMAS personas que en el frame anterior?
2. ¿Hay personas NUEVAS?
3. ¿Alguna persona del frame anterior ya NO está visible?

Para cada persona, indica:
- Si es la MISMA que en el frame anterior (y por qué: misma ropa, rasgos, posición)
- Si es NUEVA
- Cambios observados (posición, expresión, acción)

{base_prompt}"""


# =============================================================================
# PROMPT PARA ANÁLISIS ENFOCADO EN UNA PERSONA ESPECÍFICA
# =============================================================================
FACE_FOCUSED_PROMPT = """ANÁLISIS ENFOCADO EN PERSONA ESPECÍFICA

El usuario ha seleccionado una región de interés (ROI) que contiene una persona.
Enfoca tu análisis EXCLUSIVAMENTE en esta persona, proporcionando el MÁXIMO detalle posible.

{context}

Proporciona una descripción EXHAUSTIVA de esta persona específica, incluyendo
detalles que podrían pasarse por alto en un análisis general.
