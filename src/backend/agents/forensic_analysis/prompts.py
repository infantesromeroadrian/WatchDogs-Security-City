...
# =============================================================================
# PROMPT PARA ANÁLISIS DE METADATA EXIF/XMP (COMPLEMENTARIO)
# =============================================================================
METADATA_ANALYSIS_PROMPT = """Analiza los siguientes metadatos extraídos de la imagen:
...
Busca:
1. Inconsistencias entre fecha de captura y fecha de modificación
2. Software de edición usado (Adobe Photoshop, GIMP, etc.)
3. Información de cámara vs características de la imagen
4. Coordenadas GPS (si existen) vs contenido visible
5. Historial de edición en metadatos XMP
6. Firma digital o marcas de agua eliminadas

Proporciona un análisis de autenticidad basado en metadatos."""


# =============================================================================
# PROMPT PARA COMPARACIÓN DE VERSIONES
# =============================================================================
VERSION_COMPARISON_PROMPT = """Compara estas dos versiones de la imagen:

VERSIÓN 1 (presumiblemente original):
{version_1_description}

VERSIÓN 2 (versión a analizar):
{version_2_description}

Identifica:
1. Diferencias entre versiones
2. Elementos añadidos o eliminados
3. Modificaciones de color/tono
4. Cambios en el encuadre
5. Calidad/resolución diferente
